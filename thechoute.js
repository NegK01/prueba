...
case 'menu':
               ...
               txtt =`${cmenu}`              
                ...
                buttons =[ {buttonId:`ml`,buttonText:{displayText: 'Lista de Menus'},type:10},
                {buttonId:`sex`,buttonText:{displayText:'Como Tener Este Bot'},type:10},
                {buttonId:`grupo`,buttonText:{displayText:'Grupos OFC'},type:10}],
                {contextInfo: { mentionedJid: [sender,Oowner]}})
